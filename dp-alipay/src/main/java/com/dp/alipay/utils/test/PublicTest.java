 ...
 */
package com.dp.alipay.utils.test;
...
public class PublicTest {
	 ...
	 * AlipayMobilePublicAccountAddRequest request = new
	 * AlipayMobilePublicAccountAddRequest(); // 组装请求对象 BindAccountBean bean = new
	 * BindAccountBean(); bean.setAgreementId("20130829000000338233");
	 * bean.setDisplayName("尾号3190"); bean.setAppId("2013082200024933");
	 * bean.setRealName("乔蒂"); bean.setBindAccountNo("18618343190");
	 * bean.setFromUserId("2088102124069339");
	 * 
	 * JSONWriter json = new JSONWriter(); String bingUserStr = json.write(bean);
	 * 
	 * request.setBizContent(bingUserStr);
	 * 
	 * // 执行调用,转换为返回对象类型 AlipayClient client = getAlipayClient();
	 ...
	 *//**
		 ...
		 */
	/*
	 * private static void checkSign() throws AlipayApiException { Map<String,
	 * String> params = new HashMap<String, String>();
	 * 
	 * params .put( "biz_context",
	 ...
	 * ); params.put("charset", "GBK"); params.put("service",
	 * "alipay.mobile.public.message.notify"); params.put("sign_type", "RSA");
	 * params .put( "sign",
	 ...
	 * );
	 * 
	 * boolean checkSign = AlipaySignature .rsaCheckV2( params,
	...
	/*
	 * public static void menuGet() throws AlipayApiException { AlipayClient client
	 * = getAlipayClient();
	 * 
	 * AlipayMobilePublicMenuGetRequest request = new
	 * AlipayMobilePublicMenuGetRequest();
	 * 
	 ...
	 *//**
		 ...
		 */
	/*
	 * private static AlipayClient getAlipayClient() { AlipayClient client = new
	 * DefaultAlipayClient( // 线上地址 // "https://openapi.alipay.com/gateway.do", //
	 * 沙箱地址 "http://openapi.alipaydev.com/gateway.do", // 公众号ID "2013082200024933",
	 * // 公众号RSA私钥
	...
	private static void encryptAndSign() throws AlipayApiException {
		...
		String bizContent = "<XML><ToUserId><![CDATA[2088102122494786]]></ToUserId><AppId><![CDATA[2013111100036093]]></AppId><AgreementId><![CDATA[20131111000001895078]]></AgreementId>"
				+ "<CreateTime>12334349884</CreateTime>" + "<MsgType><![CDATA[image-text]]></MsgType>"
				+ "<ArticleCount>1</ArticleCount>" + "<Articles>" + "<Item>" + "<Title><![CDATA[[回复测试加密解密]]></Title>"
				+ "<Desc><![CDATA[测试加密解密]]></Desc>" + "<Url><![CDATA[http://m.taobao.com]]></Url>"
				+ "<ActionName><![CDATA[立即前往]]></ActionName>" + "</Item>" + "</Articles>"
				+ "<Push><![CDATA[false]]></Push>" + "</XML>";
		String publicKey = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDIgHnOn7LLILlKETd6BFRJ0GqgS2Y3mn1wMQmyh9zEyWlz5p1zrahRahbXAfCfSqshSNfqOmAQzSHRVjCqjsAw1jyqrXaPdKBmr90DIpIxmIyKXv4GGAkPyJ/6FTFY99uhpiq0qadD/uSzQsefWo0aTvP/65zi3eof7TcZ32oWpwIDAQAB";
		String privateKey = "";
